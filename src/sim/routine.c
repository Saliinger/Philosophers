...
/*   Updated: 2024/08/07 16:06:05 by anoukan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	loop_death(t_philo *philo)
{
	...
	{
		printf("lt %lld\nlm %lld\nls %lld\ntd %lld\nps %lld\n",
			current_timestamp() - philo->last_think, current_timestamp()
			- philo->last_meal, current_timestamp() - philo->last_sleep,
			philo->data->time_to_die, philo->start);
